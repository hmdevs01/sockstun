...
public class Preferences {
    ...
    public static final String HTTP_ADDR = "HttpAddr";
    public static final String HTTP_PORT = "HttpPort";
    public static final String HTTP_USER = "HttpUser";
    public static final String HTTP_PASS = "HttpPass";
    ...
    public String getHttpAddress() {
        return prefs.getString(HTTP_ADDR, "http://default_proxy_address");
    }

    public void setHttpAddress(String addr) {
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(HTTP_ADDR, addr);
        editor.commit();
    }

    public int getHttpPort() {
        return prefs.getInt(HTTP_PORT, 8080);
    }

    public void setHttpPort(int port) {
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(HTTP_PORT, port);
        editor.commit();
    }

    public String getHttpUsername() {
        return prefs.getString(HTTP_USER, "");
    }

    public void setHttpUsername(String user) {
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(HTTP_USER, user);
        editor.commit();
    }

    public String getHttpPassword() {
        return prefs.getString(HTTP_PASS, "");
    }

    public void setHttpPassword(String pass) {
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(HTTP_PASS, pass);
        editor.commit();
    }
