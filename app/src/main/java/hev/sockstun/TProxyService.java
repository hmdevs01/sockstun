/*
 ...
 Description : TProxy Service with HTTP proxy support
 ============================================================================
 */
...
public class TProxyService extends VpnService {
    ...
    public void startService() {
        ...
        try {
            ...
            // HTTP proxy ayarları
            tproxy_conf += "http:\n" +
                "  port: " + prefs.getHttpPort() + "\n" +
                "  address: '" + prefs.getHttpAddress() + "'\n";

            if (!prefs.getHttpUsername().isEmpty() && !prefs.getHttpPassword().isEmpty()) {
                tproxy_conf += "  username: '" + prefs.getHttpUsername() + "'\n";
                tproxy_conf += "  password: '" + prefs.getHttpPassword() + "'\n";
            }
